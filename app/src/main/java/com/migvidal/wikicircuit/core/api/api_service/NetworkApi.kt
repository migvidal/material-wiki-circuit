...
class NetworkApi @Inject constructor (private val httpClient: HttpClient):
    ...
    override suspend fun getSearch(): SearchResponse {
        ...
        return httpClient.get("https://en.wikipedia.org/w/api.php?action=query&format=json&formatversion=2&generator=prefixsearch&prop=pageimages|pageterms&piprop=thumbnail&pithumbsize=50&pilimit=10&redirects=true&wbptterms=description&gpslimit=20&gpsoffset=0&gpssearch=NYC").body<SearchResponse>()
    }
}